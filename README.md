...
根据你使用的 AI agent 平台，把对应的指令复制给它：

**Claude Code：**
> 帮我安装 ZotPilot skill：clone https://github.com/xunhe730/ZotPilot.git 到 ~/.claude/skills/zotpilot，然后帮我配置 Zotero 文献库。

**Codex CLI：**
> 帮我安装 ZotPilot skill：clone https://github.com/xunhe730/ZotPilot.git 到 ~/.agents/skills/zotpilot，然后帮我配置 Zotero 文献库。

**OpenCode（Linux/macOS）：**
> 帮我安装 ZotPilot skill：clone https://github.com/xunhe730/ZotPilot.git 到 ~/.config/opencode/skills/zotpilot，然后帮我配置 Zotero 文献库。

**OpenCode（Windows）：**
> 帮我安装 ZotPilot skill：clone https://github.com/xunhe730/ZotPilot.git 到 %APPDATA%\opencode\skills\zotpilot，然后帮我配置 Zotero 文献库。

**Gemini CLI：**
> 帮我安装 ZotPilot skill：clone https://github.com/xunhe730/ZotPilot.git 到 ~/.gemini/skills/zotpilot，然后帮我配置 Zotero 文献库。
