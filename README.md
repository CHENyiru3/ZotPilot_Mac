...
> 帮我安装 ZotPilot skill：先读 https://raw.githubusercontent.com/xunhe730/ZotPilot/main/README.md 找到你当前平台的 skills 目录，clone https://github.com/xunhe730/ZotPilot.git 到该目录（命名为 zotpilot），然后帮我配置 Zotero 文献库。
...
**（可选）获取 Zotero API 凭证** — 打标签、建集合等写操作需要：
